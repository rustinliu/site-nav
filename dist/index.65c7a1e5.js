...
function footerPosition() {
    ...
    let contentHeight = document.body.scrollHeight, winHeight = window.innerHeight; //可视窗口高度，不包括浏览器顶部工具栏
    if (!(contentHeight > winHeight)) //当网页正文高度小于可视窗口高度时，为footer添加类fixed-bottom
...
$(document).on("keypress", (e)=>{
    ...
    console.log(key);
    //实现添加时回车即确认功能
    if (key === "Enter" && !$("#addmodal").hasClass("modaldisabled")) $("#confirm").click();
});
